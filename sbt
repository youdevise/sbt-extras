...
make_url () {
  ...
  echo "$sbt_launch_url_prefix/$version/sbt-launch.jar"
}
...
declare sbt_launch_url_prefix="http://typesafe.artifactoryonline.com/typesafe/ivy-releases/org.scala-sbt/sbt-launch"
...
-sbt-launch-url-prefix) require_arg path "$1" "$2" && sbt_launch_url_prefix="$2" && shift 2 ;;
